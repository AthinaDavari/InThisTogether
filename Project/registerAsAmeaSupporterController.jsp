...
<html lang="en">
    ...
    <title>Register as Amea Supporter Controller</title>
...
if (name==null|| surname==null || email==null || password==null || confirmPassword==null || phone==null || bday==null || sex==null || sex==null || languages==null || serviceTown==null || serviceArea==null || drivLicence==null || carOwn==null || availNow==null || service==null || disab==null) {
...
if ( name.length()>=3 && surname.length()>=3 && password.length()>=5 && password.equals(confirmPassword) && (phoneIsLong) && phone.length() == 10 && !(errorEduc) && !(errorExp) && !(wrongDate) && languages.length()>=5 && serviceArea.length()>=3 ) {
    ...
    if (newPhone > 0) {
        ...
        AMEASupporter ameasup = new AMEASupporter(email, name, surname, newPhone, serviceTown, serviceArea, password, sex, birthday, languages, driversLisence, carOwner,
        ...
        ameasupdao.register(ameasup, educationList, experienceList);
%>
